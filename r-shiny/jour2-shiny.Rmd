...
Les exemples vus ci-dessus sont disponibles en ligne, dans ce qui s'appelle des [**gists**](https://gist.github.com/), hebergés sur la plateforme [**Github**](https://github.com/).

Ils sont exécutables dans **R Studio** avec la fonction suivante (du package `shiny`) :

```{r}
runGist(numero_du_gist)
runGist("url_du_gist")
```
